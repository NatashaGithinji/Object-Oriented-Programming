public class Assignment2Invoice {
    public static void main(String[] args) {
        ...
        System.out.println("----------------------------------------------------------------------------------------------------");
        System.out.println();
        System.out.print("\t\t\033[1mC026-01-0755/2024\033[0m\t\t\t\t\t\t\t\t\t");
        System.out.println("\033[1mGithinji Natasha Wanjiku\033[0m");
        System.out.print("\t\tNo 24/2, SBI Colony.\t\t\t\t\t\t\t\t");
